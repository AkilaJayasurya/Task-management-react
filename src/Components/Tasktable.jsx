            ...
            return (
              <tr key={task.id} className="border-t hover:bg-gray-50">
                ...
                <td className="px-4 py-2">
                  <Link
                    to={`/edit/${task.id}`}
                    className="inline-block px-3 py-1 bg-yellow-400 text-white rounded hover:bg-yellow-400"
                  >
                    Edit
                  </Link>
                </td>
                <td className="px-4 py-2">
                  <button
                    ...
                    className="inline-block px-3 py-1 bg-red-500 text-white rounded hover:bg-red-400"
                  >
                    Delete
                  </button>
                </td>
